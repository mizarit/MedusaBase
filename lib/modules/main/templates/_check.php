<div id="page-18" style="padding: 0;margin:0;">
  <div style="padding: 0.5em;">
    ...
    <div id="checklist-container"><p>TODO: Hier komen de controlelijsten</p></div>

  </div>
  <ul class="subnav">
    <li id="signature-btn" class="button-2" onclick="Workorder.finalizeWorkorder();">Klant laten ondertekenen</li>
  </ul>
