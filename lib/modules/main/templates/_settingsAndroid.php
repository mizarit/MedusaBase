<div id="page-4" style="padding: 0;margin:0;">
  <h2 style="margin:0;padding:0;border-top:#fff 1px solid;background:#2ea6dd;font-size:1.5em;line-height:1.6em;color:#fff;">Instellingen</h2>
  <div style="padding: 0.5em;">
    ...
    <div style="padding-left:2em;position:relative;">
      ...
      <label class="checkbox" for="notifications-sound" style="margin-bottom:0.4em;position:absolute;right:0;"> Geluid toestaan</label>
    </div>
  </div>
</div>
<script type="text/javascript">
  Event.observe(window, 'load', function() {
    ...
    $('smartkeyboard').checked = (Android.getSetting('smartkeyboard') == "1");
    if (Android.getSetting('notifications') == "0") {
      $('notifications-vibrate').disabled = 'disabled';
      $('notifications-sound').disabled = 'disabled';
    }
    if (Android.getSetting('smartkeyboard')=='') {
      Android.setSetting('smartkeyboard', "1");
    }

    if (Android.getSetting('smartkeyboard')=='0') {
      //Workorder.numberInputs(false);
    }
  });
</script>